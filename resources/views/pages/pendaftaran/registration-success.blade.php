...
<body class="d-flex justify-content-center p-4 pt-4">
    <div class="card">
        <div class="card-header bg-success text-white">Registrasi Selesai</div>
        <div class="card-body">
            hello <b>{{ request()->nama_lengkap }}</b>, thank you for joining us, soon we will approve your registration. </br>
