            ...
            <div class="card-body">
                <form action="/insertbuku" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="jumlah_stok" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-4">
                        <label for="exampleInputEmail1" class="form-label">Denda Buku</label>
                        <input type="text" name="denda_buku" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
