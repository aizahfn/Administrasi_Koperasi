...
<head>
    ...
    <title>Data berkas - SantriKoding.com</title>
                            ...
                            <tbody>
                              <?php $__empty_1 = true; $__currentLoopData = $berkas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list_berkas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('berkas.destroy', $list_berkas->id)); ?>" method="list_berkas">
...
</html><?php /**PATH G:\cod\laravel\kamisra\resources\views/berkas/index.blade.php ENDPATH**/ ?>