...
<head>
    ...
    <title>Data user - SantriKoding.com</title>
                              ...
                              <?php $__empty_1 = true; $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('user.destroy', $users->id)); ?>" method="users">
...
</html><?php /**PATH G:\cod\laravel\kamisra\resources\views/user/index.blade.php ENDPATH**/ ?>